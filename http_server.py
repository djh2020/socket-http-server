...
def response_method_not_allowed():
    ...
    return b"\r\n".join([
        ...
        b"",
        b"You can't do that on this server yet"
    ])
...
def response_path(path):
    ...
    try:
        file_handler = open(www_root + path, 'rb')
        content = file_handler.read()
        mime_type = magic.from_file(www_root + path,mime=True).encode()
        ...
        while True:
            ...
            try:
                ...
                try:
                    ...
                    print("Identified Mime Type: {}".format(mimetype))
